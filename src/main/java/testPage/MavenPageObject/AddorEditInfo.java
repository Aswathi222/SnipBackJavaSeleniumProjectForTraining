...
public class AddorEditInfo extends BasePge{
	...
	public void AI_10_AddEditInfo() throws InterruptedException{
		...
		//step 5:Click search bar and enter a game
		//Expected:User should click search bar and enter a game
		base.setData(loginObj.Edt_LoginEmail("search"),addorEditInfoTestData.AI_10_AddorEditInfo );
		base.pressKey(loginObj.Edt_LoginEmail("search"), "ENTER");
		Thread.sleep(3000);
		asrt.assertTrue(base.isExists(snipBackLoginObj.Btn_Login("AI_10_AddInfo")), "User is unable to click search bar and enter a game");

		//step 6:Click three dots of a Completed Game
		//Expected:User should click three dots of completed games
		Thread.sleep(3000);
		base.buttonClick(addorEditInfoObj.Ele_ThreeDots("AI_10_AddInfo", "btn-group dropleft right-menu-wrap"));
		asrt.assertTrue(base.isExists(addorEditInfoObj.Ele_ThreeDotsText("AI_10_AddInfo", "Edit Info")), "User is unable to see an option as Edit Info in completed games");

		//step 7: Select Add Info/Edit Info
		//Expected:The user should navigate to Score entering pop up for  My Team(Home) and Opponent Team(Away).
		String optionEdit=base.GetText(addorEditInfoObj.Ele_ThreeDotsOnClick("AI_10_AddInfo","getGameInfo"));
		if (optionEdit == "Add Info") {
			base.buttonClick(addorEditInfoObj.Ele_ThreeDotsText("AI_10_AddInfo", "Add Info"));
			asrt.assertTrue(
					base.isExists(addorEditInfoObj.Ele_AddInfoText("HOME")) &&
					base.isExists(addorEditInfoObj.Ele_AddInfoText("AWAY")),
					"User is unable to navigate to score entering pop up for My team(Home) & Opponent Team(Away)"
					);
		} else {
			base.buttonClick(addorEditInfoObj.Ele_ThreeDotsText("AI_10_AddInfo", "Edit Info"));
			asrt.assertTrue(
					base.isExists(addorEditInfoObj.Ele_AddInfoText("HOME")) &&
					base.isExists(addorEditInfoObj.Ele_AddInfoText("AWAY")),
					"User is unable to navigate to score editing pop up for My team(Home) & Opponent Team(Away)"
					);
		}

		//step 8:Enter the score(HOME)
		//Expected: User should enter the score(HOME)
		base.setData(loginObj.Edt_LoginEmail("home_team_point"),addorEditInfoTestData.AI_10_AddInfoHome );
		String home=base.GetValue(loginObj.Edt_LoginEmail("home_team_point"));
		asrt.assertEquals(home, addorEditInfoTestData.AI_10_AddInfoHome,"User is unable to enter in the score(HOME)");

		//step 9: Enter the score(AWAY)
		//Expected: User should enter score(AWAY)
		base.setData(loginObj.Edt_LoginEmail("away_team_point"),addorEditInfoTestData.AI_10_AddInfoAway);
		String away=base.GetValue(loginObj.Edt_LoginEmail("away_team_point"));
		asrt.assertEquals(away, addorEditInfoTestData.AI_10_AddInfoAway,"User is unable to enter in the score(AWAY)");

		//step 10:Click Save
		//Expected:Users can enter numeric values in the score field.
		base.buttonClick(scheduleUnscheduleGamesObj.Btn_Create("btn btn-primary save-btn", "SAVE"));
		asrt.assertTrue(base.isExists(loginObj.Edt_AlertText("Done!")), "User is unable to enter numeric values in the score field");		
	}
	//<Summary>
	//Test case Title:Verify whether the user can able to change the result of Game.
	//Automation ID: AI_12
	//</Summary>
	public void AI_12_AddEditInfo() throws InterruptedException{
		...
		//step 5:Click search bar and enter a game
		//Expected:User should click search bar and enter a game
		base.setData(loginObj.Edt_LoginEmail("search"),addorEditInfoTestData.AI_12_AddorEditInfo );
		base.pressKey(loginObj.Edt_LoginEmail("search"), "ENTER");
		Thread.sleep(3000);
		asrt.assertTrue(base.isExists(snipBackLoginObj.Btn_Login("AI_12_AddInfo")), "User is unable to click search bar and enter a game");

		//step 6:Click three dots of a Completed Game
		//Expected:User should click three dots of completed games
		Thread.sleep(3000);
		base.buttonClick(addorEditInfoObj.Ele_ThreeDots("AI_12_AddInfo", "btn-group dropleft right-menu-wrap"));
		asrt.assertTrue(base.isExists(addorEditInfoObj.Ele_ThreeDotsText("AI_12_AddInfo", "Edit Info")), "User is unable to see an option as Edit Info in completed games");

		//step 7: Select Add Info/Edit Info
		//Expected:The user should navigate to Score entering pop up for  My Team(Home) and Opponent Team(Away).
		base.buttonClick(addorEditInfoObj.Ele_ThreeDotsText("AI_12_AddInfo", "Edit Info"));
		asrt.assertTrue((base.isExists(addorEditInfoObj.Ele_AddInfoText("HOME")) && (base.isExists(addorEditInfoObj.Ele_AddInfoText("AWAY")))), "User is unable to navigate to score entering pop up for My team(Home) & Opponent Team(Away)");

		//step 8:Enter the score(HOME)
		//Expected: User should enter the score(HOME)
		base.setData(loginObj.Edt_LoginEmail("home_team_point"),addorEditInfoTestData.AI_12_AddInfoHome );
		String home=base.GetValue(loginObj.Edt_LoginEmail("home_team_point"));
		asrt.assertEquals(home, addorEditInfoTestData.AI_12_AddInfoHome,"User is unable to enter in the score(HOME)");

		//step 9: Enter the score(AWAY)
		//Expected: User should enter score(AWAY)
		base.setData(loginObj.Edt_LoginEmail("away_team_point"),addorEditInfoTestData.AI_12_AddInfoAway);
		String away=base.GetValue(loginObj.Edt_LoginEmail("away_team_point"));
		asrt.assertEquals(away, addorEditInfoTestData.AI_12_AddInfoAway,"User is unable to enter in the score(AWAY)");

		//step 10:Change WIN to LOSE/viceversa
		//Expected: User should change WIN to LOSE/viceversa
		base.excuteJsClick(addorEditInfoObj.Ele_GameWinClick("checkbox", "switcher-1"));
		asrt.assertTrue(base.isEnabledBy(addorEditInfoObj.Ele_GameWinClick("checkbox", "switcher-1")), "User is unable to change WIN to LOSE/viceversa");

		//step 11:Click Save
		//Expected:User can able to edit the result of Game.
		base.buttonClick(scheduleUnscheduleGamesObj.Btn_Create("btn btn-primary save-btn", "SAVE"));
		asrt.assertTrue(base.isExists(loginObj.Edt_AlertText("Done!")), "User is unable to enter numeric values in the score field");
	}
}
