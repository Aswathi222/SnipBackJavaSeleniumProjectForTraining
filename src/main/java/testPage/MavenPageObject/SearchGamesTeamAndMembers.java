...
public class SearchGamesTeamAndMembers extends BasePge{
	...
	public void SH_03_SearchGamesTeamAndMembers() throws InterruptedException{
		...
		asrt.assertTrue(elementActions.isExistsInText(gameTexts, searchGamesTeamAndMembersTestData.SH_03_SearchGamesTeamAndMembers_Number), "User is unable to view the list of games with the given number.");
	}
	...
	public void SH_07_SearchGamesTeamAndMembers() throws InterruptedException{
		...
		asrt.assertTrue(elementActions.isExistsInStart(firstLetter, searchGamesTeamAndMembersTestData.SH_07_SearchGamesTeamAndMembers),"User is unable to click and enter the first letter of team name in search bar");
	}
	//<Summary>
	...
	public void SH_08_SearchGamesTeamAndMembers() throws InterruptedException{
		...
		asrt.assertTrue(elementActions.isExistsInText(number, searchGamesTeamAndMembersTestData.SH_08_SearchGamesTeamAndMembers),"User is unable to see the list of teams with given number");
	}
	//<Summary>
	...
	public void SH_09_SearchGamesTeamAndMembers() throws InterruptedException{
		...
		asrt.assertTrue(elementActions.isExistsInText(special, searchGamesTeamAndMembersTestData.SH_09_SearchGamesTeamAndMembers_Special),"User is unable to see the list of teams with the given special character");
	}
	//<Summary>
	...
	public void SH_10_SearchGamesTeamAndMembers() throws InterruptedException{
		...
		asrt.assertFalse(elementActions.isExistsInText(noTeam, searchGamesTeamAndMembersTestData.SH_10_SearchGamesTeamAndMembers_Noteam),"User is able to see the list of team name");
	}
	//<Summary>
	...
	public void SH_12_SearchGamesTeamAndMembers() throws InterruptedException{
		...
		asrt.assertTrue(elementActions.isExistsInText(firstLetter, searchGamesTeamAndMembersTestData.SH_12_SearchGamesTeamAndMembers),"User is unable to click search bar and unable to see the list of members with given first letter");
	}
}
