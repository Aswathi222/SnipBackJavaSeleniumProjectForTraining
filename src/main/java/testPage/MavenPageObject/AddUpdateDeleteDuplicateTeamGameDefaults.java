...
public class AddUpdateDeleteDuplicateTeamGameDefaults  extends BasePge{
	...
	// </summary>
	public void Team_33_AddUpdateDeleteDuplicateTeamGameDefaults() throws InterruptedException 
	{
		LoginPage_Obj loginObj=new LoginPage_Obj();
		Login login = new Login(driver);
		CreateEditDeletePool_Obj CreateEditDeletePoolObj = new CreateEditDeletePool_Obj();
		...
		//Expected : User is able to Switch the organization if the User as Admin/Coach
		base.buttonClick(CreateEditDeletePoolObj.Btn_Film("navbar-nav ms-auto", "Film"));
		base.selectorByVisibleText(createandaddnewmemberobj.DdlOrg("form-select select-form film-organizations"),addupdatedeleteobj.Team_33_SelectedValueAdmin);
		String selectOrg=element.DropDownText(createandaddnewmemberobj.DdlOrg("form-select select-form film-organizations"));			
		asrt.assertEquals(selectOrg,addupdatedeleteobj.Team_33_SelectedValueAdmin,"User is unable to Switch the organization if the User as Admin/Coach");
		...
		//Step 4 : Enter team name
		//Expected : User is able to enter team name
		base.setData(createandaddnewmemberobj.Ele_SearchGame("form-control form-control-wrap"),addupdatedeleteobj.Team_33_TeamName);
		asrt.assertTrue(base.isExists(scheduleobj.Btn_EventOK("btn btn-success teamname-ok-btn")),"User is unable to enter team name");

		//Step 5: Change default team type
		//Expected :User is able to Change Default team type
		base.selectorByVisibleText(CreateEditDeletePoolObj.Sel_PoolType("category"),addupdatedeleteobj.Team_33_SelectedDropdown);
		String selectedDropdown=element.DropDownText(CreateEditDeletePoolObj.Sel_PoolType("category"));	
		asrt.assertEquals(selectedDropdown ,addupdatedeleteobj.Team_33_SelectedDropdown," User is unable to Select default team type");
		...
		//Step 7: Verify that "Data saved successfully" message should be displayed when we click on Save icon
		//Expected : "Data saved successfully" message should be displayed when we click on Save icon
		base.excuteJsClick(addUpdateObject.Btn_Close("modal","show","modalMessageCloseBtn","Close"));
	...
	// <summary>
	// Test Case Title :Verify that when click on No option the popup message "Are you sure want to delete this team?" should be closed 
	...
	public void Team_36_AddUpdateDeleteDuplicateTeamGameDefaults() throws InterruptedException 
	{
		...
		//Expected : User is able to Switch the organization if the User as Admin/Coach
		base.buttonClick(CreateEditDeletePoolObj.Btn_Film("navbar-nav ms-auto", "Film"));
		base.selectorByVisibleText(createandaddnewmemberobj.DdlOrg("form-select select-form film-organizations"),addupdatedeleteobj.Team_36_SelectedValueAdmin);
		String selectOrg=element.DropDownText(createandaddnewmemberobj.DdlOrg("form-select select-form film-organizations"));			
		asrt.assertEquals(selectOrg,addupdatedeleteobj.Team_36_SelectedValueAdmin,"User is unable to Switch the organization if the User as Admin/Coach");

		//Step 3 : Click on three dots 
		//Expected : User is able to Click on three dots of the team
		base.setData(loginObj.Edt_LoginEmail("searchTeam"),addupdatedeleteobj.Team_36_TeamName);
		Thread.sleep(1000);
		base.pressKey(loginObj.Edt_LoginEmail("searchTeam"), "ENTER");
		Thread.sleep(1000);
		base.excuteJsClick(regObj.Btn_ResendOTP("defaultDropdown-3"));	
		...
		//Expected : Verify that when click on No option the popup message "Are you sure want to delete this team?" should be closed 
		base.excuteJsClick(scheduleobj.Btn_EventOK("swal-button swal-button--cancel"));	
		asrt.assertTrue(base.isDoesNotExistBool(loginObj.Edt_AlertText("Are you sure want to delete this team?")),"User is unable to click No option and the popup message 'Are you sure want to delete this team?' is not closed ");
	}
}
