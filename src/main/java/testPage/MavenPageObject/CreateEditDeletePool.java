...
public class CreateEditDeletePool extends BasePge {
	...
	public void TC_02_CreateEditDeletePool() throws InterruptedException{
		...
		String poolType=base.GetValue(createEditDeletePoolObj.Sel_PoolType("pool_type"));
		asrt.assertEquals(poolType, createEditDeletePool_testdata.TC_02_CreateEditDeletePool_dropdwn);
