...
public class SnipBackRegistration extends BasePge{
	...
	public void TC01_Registration() 
	{
		...
		asrt.assertTrue(base.isExists(RegistrationObj.Btn_SigUp1("btn-signup")),"User unable to find a pop up meggase.");
		...
		base.buttonClick(RegistrationObj.Btn_SigUp1("btn-signup"));
		asrt.assertTrue(base.isExists(RegistrationObj.Btn_SigUp1("btn-signup")),"User unable to enter name with numbers and special characters  ");
