...
{	
	...
	@Test()
	public void AI_06_AddorEditInfoTest() throws Exception 
	{	
		AddorEditInfo AddorEditInfoTest=new AddorEditInfo(getDriver());
		AddorEditInfoTest.AI_06_AddEditInfo();
	}
	@Test()
	public void AI_07_AddorEditInfoTest() throws Exception 
	{	
		AddorEditInfo AddorEditInfoTest=new AddorEditInfo(getDriver());
		AddorEditInfoTest.AI_07_AddEditInfo();
	}
	@Test()
	public void AI_08_AddorEditInfoTest() throws Exception 
	{	
		AddorEditInfo AddorEditInfoTest=new AddorEditInfo(getDriver());
		AddorEditInfoTest.AI_08_AddEditInfo();
	}
	@Test()
	public void AI_09_AddorEditInfoTest() throws Exception 
	{	
		AddorEditInfo AddorEditInfoTest=new AddorEditInfo(getDriver());
		AddorEditInfoTest.AI_09_AddEditInfo();
	}
	@Test()
	public void AI_10_AddorEditInfoTest() throws Exception 
	{	
		AddorEditInfo AddorEditInfoTest=new AddorEditInfo(getDriver());
		AddorEditInfoTest.AI_10_AddEditInfo();
	}
}
